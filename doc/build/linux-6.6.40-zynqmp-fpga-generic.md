...
```console
shell$ git tag -a v6.6.40-zynqmp-fpga -m "release v6.6.40-zynqmp-fpga-generic-2"
...
```console
shell$ cp arch/arm64/boot/Image.gz ../vmlinuz-6.6.40-zynqmp-fpga-generic-2
shell$ cp .config             ../files/config-6.6.40-zynqmp-fpga-generic-2
```

### Install devicetree to this repository

```console
shell$ install -d ../devicetrees/6.6.40-zynqmp-fpga-generic-2
shell$ cp arch/arm64/boot/dts/xilinx/* ../devicetrees/6.6.40-zynqmp-fpga-generic-2
```
