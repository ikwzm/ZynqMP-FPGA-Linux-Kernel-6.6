...
KERNEL_DEFCONFIG=zynqmp_fpga_debug_defconfig
...
patch -p1 < ../patches/linux-$KERNEL_VERSION-xlnx-v2024.2/400_debug_9_drivers-of.patch
git add --all
git commit -m "[update] drivers/of for debug print"

### Patch for of fix

patch -p1 < ../patches/linux-$KERNEL_VERSION-xlnx-v2024.2/400_debug_9_drivers-of-fix.patch
git add --all
git commit -m "[fix] drivers: core: device leak in __fw_devlink_relax_cycles()"
